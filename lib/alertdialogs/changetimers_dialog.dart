...
Future<void> showChangeTimersDialog(
  ...
  await showDialog<void>(
    ...
    builder: (BuildContext context) {
      ...
      // Method to calculate and store totalTimer, setTimer and restTimer
      // to their corresponding Providers and Firestore
      Future<void> setAndStoreTimers(WidgetRef ref) async {
        await ref
            ...
            .then((_) async {
          await ref.read(setTimerProvider.notifier).updateSetTimer(
                context,
                ref,
                setTimerCtrl.text,
              );
        }).then((_) async {
          await ref.read(restTimerProvider.notifier).updateUserWeight(
                context,
                ref,
                restTimerCtrl.text,
              );
              ...
              children: <Widget>[
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: ref.watch(totalTimerProvider),
                ...
                TextField(
                  ...
                  textAlign: TextAlign.center,
                  decoration: InputDecoration(
                    labelText: ref.watch(setTimerProvider),
                    prefixIcon: const Icon(
                ...
                TextField(
                  ...
                  textAlign: TextAlign.center,
                  decoration: InputDecoration(
                    labelText: ref.watch(restTimerProvider),
                    prefixIcon: const Icon(
